...
_SCR_ADC_SelectChannel_channel_65536_40:
	.ds.b	1
_SCR_ADC_IsResultValid_return_char_65536_45:
	.ds.b	1
_SCR_ADC_GetResult_return_result_65536_48:
	.ds.b	1
_SCR_ADC_StartNewConversionGetResult_Result_65536_50:
	.ds.b	1
;--------------------------------------------------------
; code
;--------------------------------------------------------
...
;------------------------------------------------------------
;channel                   Allocated with name '_SCR_ADC_SelectChannel_channel_65536_40'
;------------------------------------------------------------
...
_SCR_ADC_SelectChannel:
	.using 0
	mov	a,dpl
	mov	dptr,#_SCR_ADC_SelectChannel_channel_65536_40
	movx	@dptr,a
...
;------------------------------------------------------------
;return_char               Allocated with name '_SCR_ADC_IsResultValid_return_char_65536_45'
;------------------------------------------------------------
...
;	../SCR/SCR_ADC_Init.c:107: unsigned char return_char = ADCNORESULTORINVALID;
	mov	dptr,#_SCR_ADC_IsResultValid_return_char_65536_45
	clr	a
	movx	@dptr,a
...
;------------------------------------------------------------
;return_result             Allocated with name '_SCR_ADC_GetResult_return_result_65536_48'
;------------------------------------------------------------
...
;	../SCR/SCR_ADC_Init.c:121: return_result = SCR_ADCOMP_RES;
	mov	dptr,#_SCR_ADC_GetResult_return_result_65536_48
...
;------------------------------------------------------------
;Result                    Allocated with name '_SCR_ADC_StartNewConversionGetResult_Result_65536_50'
;ADC_Timeout               Allocated with name '_SCR_ADC_StartNewConversionGetResult_ADC_Timeout_65536_50'
;------------------------------------------------------------
...
;	../SCR/SCR_ADC_Init.c:126: unsigned char Result=0;
	mov	dptr,#_SCR_ADC_StartNewConversionGetResult_Result_65536_50
	clr	a
	movx	@dptr,a
