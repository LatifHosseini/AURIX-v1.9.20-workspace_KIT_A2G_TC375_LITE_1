...
;--------------------------------------------------------
	.file	"Select_Interrupt_Priority.c"
;	.optsdcc -mmcs51
	; --model-large
...
;--------------------------------------------------------
;------------------------------------------------------------
;Allocation info for local variables in function 'SCR_Select_Interrupt_Priority'
;------------------------------------------------------------
;	../SCR/Select_Interrupt_Priority.c:55: void SCR_Select_Interrupt_Priority(void)
;	-----------------------------------------
;	 function SCR_Select_Interrupt_Priority
;	-----------------------------------------
	.section .text.code.SCR_Select_Interrupt_Priority,"ax" ;code for function SCR_Select_Interrupt_Priority
