...
; bit data
;--------------------------------------------------------
	.section .bitdata.i51,"aw" ;bit_name ;area
_IsStandbyMode_sloc0_1_0:
	.ds.b	1
;--------------------------------------------------------
; code
;--------------------------------------------------------
;------------------------------------------------------------
;Allocation info for local variables in function 'IsStandbyMode'
;------------------------------------------------------------
;	../SCR/IsStandbyMode.c:53: unsigned char IsStandbyMode(void){
;	-----------------------------------------
;	 function IsStandbyMode
;	-----------------------------------------
	.section .text.code.IsStandbyMode,"ax" ;code for function IsStandbyMode
	.type   IsStandbyMode, @function
_IsStandbyMode:
	.using 0
;	../SCR/IsStandbyMode.c:60: SCR_SCU_PAGE = 0;
	mov	_SCR_SCU_PAGE,#0x00
;	../SCR/IsStandbyMode.c:61: return (SCR_SCU_SR && 0x4);
	mov	a,_SCR_SCU_SR
	jnz	.00104
.00110:
;	assignBit
	clr	_IsStandbyMode_sloc0_1_0
	sjmp	.00105
.00104:
;	assignBit
	setb	_IsStandbyMode_sloc0_1_0
.00105:
	mov	c,_IsStandbyMode_sloc0_1_0
	clr	a
	rlc	a
;	../SCR/IsStandbyMode.c:62: }
	mov	dpl,a
.00101:
	ret
