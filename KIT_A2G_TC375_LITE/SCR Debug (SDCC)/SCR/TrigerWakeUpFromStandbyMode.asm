...
;--------------------------------------------------------
	.file	"TrigerWakeUpFromStandbyMode.c"
;	.optsdcc -mmcs51
	; --model-large
...
;--------------------------------------------------------
	.globl	_TrigerWakeUpFromStandbyMode
;--------------------------------------------------------
...
;--------------------------------------------------------
;------------------------------------------------------------
;Allocation info for local variables in function 'TrigerWakeUpFromStandbyMode'
;------------------------------------------------------------
;	../SCR/TrigerWakeUpFromStandbyMode.c:53: void TrigerWakeUpFromStandbyMode(void){
;	-----------------------------------------
;	 function TrigerWakeUpFromStandbyMode
;	-----------------------------------------
	.section .text.code.TrigerWakeUpFromStandbyMode,"ax" ;code for function TrigerWakeUpFromStandbyMode
	.type   TrigerWakeUpFromStandbyMode, @function
_TrigerWakeUpFromStandbyMode:
	.using 0
;	../SCR/TrigerWakeUpFromStandbyMode.c:55: SCR_SCU_PAGE = 1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/TrigerWakeUpFromStandbyMode.c:56: SCR_SCU_STDBYWKP |= (1 << 0); //set Bit 0 of SCU_STDBYWKP Register to 1 then trigger a wakeup
	orl	_SCR_SCU_STDBYWKP,#0x01
.00101:
;	../SCR/TrigerWakeUpFromStandbyMode.c:57: }
	ret
