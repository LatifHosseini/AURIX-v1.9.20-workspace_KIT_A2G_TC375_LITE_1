...
;--------------------------------------------------------
	.file	"CCU_Capture_Mode_1_Config.c"
;	.optsdcc -mmcs51
	; --model-large
...
;--------------------------------------------------------
	.globl	_SCR_CCU_Capture_Mode_1_Config
;--------------------------------------------------------
...
;--------------------------------------------------------
;------------------------------------------------------------
;Allocation info for local variables in function 'SCR_CCU_Capture_Mode_1_Config'
;------------------------------------------------------------
;	../SCR/CCU_Capture_Mode_1_Config.c:55: void SCR_CCU_Capture_Mode_1_Config(void)
;	-----------------------------------------
;	 function SCR_CCU_Capture_Mode_1_Config
;	-----------------------------------------
	.section .text.code.SCR_CCU_Capture_Mode_1_Config,"ax" ;code for function SCR_CCU_Capture_Mode_1_Config
	.type   SCR_CCU_Capture_Mode_1_Config, @function
_SCR_CCU_Capture_Mode_1_Config:
	.using 0
;	../SCR/CCU_Capture_Mode_1_Config.c:57: SCR_T2CCU_PAGE = 1;
	mov	_SCR_T2CCU_PAGE,#0x01
;	../SCR/CCU_Capture_Mode_1_Config.c:58: SCR_T2CCU_CCTBSEL |= (1 << 0) ; // //CCT as Time Bse Timer Bit pos 0 for capture chanel 0
	orl	_SCR_T2CCU_CCTBSEL,#0x01
;	../SCR/CCU_Capture_Mode_1_Config.c:62: SCR_T2CCU_CCEN = (SCR_T2CCU_CCEN & (unsigned char)(~(0x03 << 0))) | (0x03);
	mov	a,#0xFC
	anl	a,_SCR_T2CCU_CCEN
	orl	a,#0x03
	mov	_SCR_T2CCU_CCEN,a
.00101:
;	../SCR/CCU_Capture_Mode_1_Config.c:65: }
	ret
