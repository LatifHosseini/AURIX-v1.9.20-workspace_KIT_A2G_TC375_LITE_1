...
;------------------------------------------------------------
;	../SCR/SCR_GPIO_Init.c:62: void gpio_init(void){
;	-----------------------------------------
;	 function gpio_init
;	-----------------------------------------
	.section .text.code.gpio_init,"ax" ;code for function gpio_init
...
;	../SCR/SCR_GPIO_Init.c:67: SCR_P01_PDISC = EnablePortPad;
...
;	../SCR/SCR_GPIO_Init.c:72: SCR_P00_IOCR3 = PUSH_PULL_GENERAL_PURPOSE_OUTPUT;
