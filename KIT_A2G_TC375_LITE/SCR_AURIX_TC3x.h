...
#define LABEL_scr_xram__main_cnt_65536_29      (7428) /*(0x1d04) */
...
#define LABEL_scr_xram__00101      (448) /*(0x1c0) */
#define LABEL_scr_xram__00101      (460) /*(0x1cc) */
#define LABEL_scr_xram__00103      (496) /*(0x1f0) */
#define LABEL_scr_xram__00105      (500) /*(0x1f4) */
#define LABEL_scr_xram__00101      (507) /*(0x1fb) */
...
#define LABEL_scr_xram___xdatai_end      (7433) /*(0x1d09) */
#define LABEL_scr_xram__edge_counter      (7432) /*(0x1d08) */
...
#define LABEL_scr_xram__FellingEdge      (7424) /*(0x1d00) */
#define LABEL_scr_xram___init_table      (256) /*(0x100) */
#define LABEL_scr_xram_s_XISEG      (7432) /*(0x1d08) */
#define LABEL_scr_xram__SCR_Select_Interrupt_Priority      (501) /*(0x1f5) */
#define LABEL_scr_xram__main      (508) /*(0x1fc) */
