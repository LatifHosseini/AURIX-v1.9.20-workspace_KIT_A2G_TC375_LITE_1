...
{
    /* Initialization of the LED used in this example */
    IfxPort_setPinModeOutput(PWM_SCR , IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
    /* Switch OFF the LED */
    IfxPort_setPinHigh(PWM_SCR);
}

void blinkP00_0(void)
{
    IfxPort_togglePin(PWM_SCR);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME));    /* Wait 500 milliseconds                */
}
...
{
    IfxPort_togglePin(LED_2);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME));    /* Wait 500 milliseconds                */
}
