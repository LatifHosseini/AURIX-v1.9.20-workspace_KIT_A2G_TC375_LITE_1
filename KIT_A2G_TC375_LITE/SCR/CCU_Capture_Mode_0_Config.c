...
void SCR_CCU_Capture_Mode_0(void)
{
    ...
    //T2CCU_CCEN.CCMx = 01 //HD-triggered capture Capture with External both edge. Bit position 0-1 for capture channel 0
   // SCR_T2CCU_CCEN = (SCR_T2CCU_CCEN & (unsigned char)(~(0x03 << 0))) | (0x01);

    //T2CCU_CCEN.CCMx = 11 // software-triggered capture. Bit position 0-1 for capture channel 0
